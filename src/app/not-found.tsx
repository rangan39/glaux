  ...
  return (
    <main className="relative flex h-svh items-center justify-center overflow-hidden bg-sophon-canvas p-6 text-foreground">
      ...
      <section className="sophon-glass-strong relative w-full max-w-md rounded-2xl p-6 text-center">
        ...
        <h1 className="mt-3 font-mono text-sm font-semibold uppercase tracking-[0.12em] text-sophon-copy-primary">Channel not found</h1>
        <p className="mt-2 text-sm leading-6 text-sophon-copy-body">This Sophon route does not exist.</p>
