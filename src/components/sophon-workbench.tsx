          ...
          <div className="flex min-w-0 items-center gap-2 sm:gap-3" data-testid="workbench-brand">
            ...
            <div className={cn("min-w-0", selectedModel && "max-[359px]:hidden")}>
              <div className="flex items-center gap-2">
                ...
                <span className="sophon-type-decorative hidden items-center rounded-md border border-sophon-signal-bright/40 bg-sophon-signal/10 px-2 py-0.5 font-mono font-medium uppercase tracking-[0.12em] text-sophon-signal-soft sm:inline-flex" data-typography-role="decorative">Open-source local AI</span>
              </div>
              <p className="sophon-type-metadata hidden font-mono uppercase tracking-[0.12em] text-sophon-copy-metadata md:block" data-typography-role="metadata">Multilingual AI, in your browser</p>
            </div>
          </div>
