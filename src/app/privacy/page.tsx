      ...
      <article className="sophon-glass-strong relative mx-auto max-w-3xl rounded-3xl px-6 py-8 sm:px-10 sm:py-12">
        ...
        <div className="privacy-copy mt-8 space-y-8 text-sm leading-7 text-sophon-copy-body sm:text-base" data-typography-role="body">
          ...
          <section>
            ...
            <p>Downloaded or partially downloaded data for the selected model remains in browser-private storage until you switch models, delete it, the browser evicts it, you clear the extension&apos;s site data, or you uninstall the extension. Switching models removes all saved model files before starting the new download from scratch. If Sophon detects multiple model downloads left by an older version, it removes all of them before restoring a model. Open <strong>Models</strong> and use the delete control to remove the current model&apos;s weights, checkpoints, and cached runtime files. To remove all Sophon data, delete the saved model, reset the conversation, and uninstall Sophon from <code>chrome://extensions</code> or clear its stored data through Chrome&apos;s site-data controls.</p>
          </section>
