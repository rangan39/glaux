  ...
  return (
    <main className="relative flex h-svh items-center justify-center overflow-hidden bg-sophon-canvas p-6 text-foreground">
      ...
      <section className="sophon-glass-strong relative w-full max-w-md rounded-2xl border-destructive/35 p-6" role="alert">
        ...
        <h1 className="mt-4 font-mono text-sm font-semibold uppercase tracking-[0.12em] text-sophon-copy-primary">Sophon failed to render</h1>
        <p className="mt-2 text-sm leading-6 text-sophon-copy-body">The inference console hit an unexpected interface error. Retry the view; your local model data has not been sent anywhere.</p>
