...
const manifests = [
  manifest("tiny-aya-global", "onnx-community/tiny-aya-global-ONNX", "7fff1be9627e40f0d89c33f406882bdafb56ec90", [
    ...
    ["config.json", "tiny-aya-global/config.json", 2_318, "3da94717f60de9b404cca64311a3f0d50c6847974c5d7b61b178cc32f32cb621"],
    ["onnx/model_q4f16.onnx", "shared/model_q4f16.onnx", 362_391, "0fd23a22d297e492b29cb58c2011374c6851fd2afdadd0d151859721b4faffa7"],
    ["generation_config.json", "tiny-aya-global/generation_config.json", 136, "3a9136deba1bd98df479931c7dd92c141684994e65bfdfa97d9ddc7d9cab1319"],
    ["tokenizer.json", "shared/tokenizer.json", 21_077_804, "0b0eea0844526f017ce46eed1de63cbf754145115b716193a74263bb3c93c9e3"],
    ["tokenizer_config.json", "shared/tokenizer_config.json", 3_846, "94f0ef9258bbdb7c0b731e71036af816718c22a1a4f190a83b5028ebae4e040d"]
  ]),
  manifest("tiny-aya-earth", "onnx-community/tiny-aya-earth-ONNX", "24a24ee8b8483762575fe734e57bad21ca36d8c6", [
    ...
    ["config.json", "tiny-aya-regional/config.json", 2_313, "d85da832ee269666e8c57e19f620f77cee34bb449cb6d8bcce7dfd3bd921adb0"],
    ["onnx/model_q4f16.onnx", "shared/model_q4f16.onnx", 362_391, "0fd23a22d297e492b29cb58c2011374c6851fd2afdadd0d151859721b4faffa7"],
    ["generation_config.json", "tiny-aya-regional/generation_config.json", 131, "b4886e47fa2a2b0ef6f17019655625e0acb86b60536d08e62da007dc6326164d"],
    ["tokenizer.json", "shared/tokenizer.json", 21_077_804, "0b0eea0844526f017ce46eed1de63cbf754145115b716193a74263bb3c93c9e3"],
    ["tokenizer_config.json", "shared/tokenizer_config.json", 3_846, "94f0ef9258bbdb7c0b731e71036af816718c22a1a4f190a83b5028ebae4e040d"]
  ]),
...
export function getBundledArtifactUrl(artifact: Pick<ModelAuxiliaryArtifact, "bundledPath">) {
  return `/model-runtime/${artifact.bundledPath}`;
}
...
function manifest(
  ...
  auxiliary: readonly (readonly [path: string, bundledPath: string, size: number, sha256: string])[]
  ...
  return {
    ...
    auxiliary: auxiliary.map(([path, bundledPath, size, sha256]) => ({ path, bundledPath, size, sha256 }))
  };
}
