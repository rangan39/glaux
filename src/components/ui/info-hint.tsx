...
export function InfoHint({ className, concept }: InfoHintProps) {
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent className="sophon-type-metadata z-[70] max-w-[17.5rem] rounded-lg border border-sophon-glass-border bg-sophon-panel/95 px-3 py-2.5 text-left font-normal tracking-normal text-sophon-copy-body shadow-[0_18px_52px_var(--sophon-glass-shadow),inset_0_1px_0_var(--sophon-glass-highlight)] backdrop-blur-xl" data-help-id={concept} data-slot="tooltip-content">
