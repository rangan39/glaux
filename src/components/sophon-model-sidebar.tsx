...
export function GlauxModelSidebar({ activeModelId, cacheSummaries = [], capabilities, communityModels = [], deletingModelId = null, disabled = false, downloadPercent, downloadPercentLabel, inspectDisplayMode = null, inspectMetrics, inspectMode = false, loadedModelId, loading = false, loadingLabel = "Downloading", mobileOpen, modelId, onCommunityModelAdded, onDelete, onDownload, onInspectDisplayModeChange, onInspectModeChange, onMobileOpenChange, onSelect, recommendedModelId }: Props) {
  const [expanded, setExpanded] = useState(true);
  const panelProps = { activeModelId, cacheSummaries, capabilities, communityModels, deletingModelId, disabled, downloadPercent, downloadPercentLabel, inspectDisplayMode, inspectMetrics, inspectMode, loadedModelId, loading, loadingLabel, modelId, onCommunityModelAdded, onDelete, onDownload, onInspectDisplayModeChange, onInspectModeChange, onSelect, recommendedModelId };
  return <>
...
function ModelPanel({ activeModelId, cacheSummaries = [], capabilities, communityModels = [], deletingModelId = null, disabled = false, downloadPercent, downloadPercentLabel, expanded, inspectDisplayMode = null, inspectMetrics, inspectMode = false, loadedModelId, loading, loadingLabel, mobile = false, modelId, onClose, onCommunityModelAdded, onDelete, onDownload, onInspectDisplayModeChange, onInspectModeChange, onSelect, onToggle, recommendedModelId }: PanelProps) {
